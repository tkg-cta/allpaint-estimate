  ...
  <>
   ...
   >
    ...
    <div className="w-28 h-28 sm:w-32 sm:h-32 flex-shrink-0 bg-gray-100 relative border-r border-gray-100">
     <img src={paint.image} alt={paint.name} className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" />
     {isSelected && (
   ...
   >
    ...
    <div className="p-4">
     ...
     <div className="flex items-baseline justify-between">
      <span className="text-sm text-gray-500">追加料金</span>
